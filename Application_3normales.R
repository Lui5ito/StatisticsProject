...
# une loi de Poisson, une loi normale et deux lois normales.
...
saveRDS(resultats, file = "resultats_3normales.RData")
################################################################################
##--------------------------------RESULTATS-----------------------------------##
################################################################################
...
graph_groupe_1 <- ggplot(proportion_25, aes(x = nb_transcrit)) +
  ...
  theme(legend.title = element_blank())+
  labs(title = "Fonction de masse de la loi de Poisson et densité de la loi normale superposée aux données réelles") +
